...
public class Variables {
	...
	protected static Property OldKentRd=new Property();
	
	// (BlockID,BlockName,BlockPrice,BlockRent)
	

//	properties.add(Property(1,Start,null,{2,10,30,90,160,250},))
//	properties.add(Property(2,OldKentRd,60,{4,20,60,180,320,450},))
